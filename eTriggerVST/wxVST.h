...
#include <wx/panel.h>
#include "../lib-src/VSTSDK/source/common/AEffEditor.hpp"
#include "../lib-src/VSTSDK/source/common/audioeffectx.h"
...
////////////////////////////////////////
class wxVstEffectX : public AudioEffectX
{
public:
	wxVstEffectX (audioMasterCallback audioMaster);
	~wxVstEffectX ();
