//// CpuUsage.h ////////////////////////////////////////////////
//
//   Gettin the CPU usage of a process is pretty easy.
//
//   Example:
//   --------------------
//   
//   #include "CpuUsage.h"
//
//   CCpuUsage cpuProcess;
//
//   int cpu = cpuProcess.GetCpuUsage("etrigger");
//
//   //cpu now holds the percent of CPU used by eTrigger.
//   //just keep updating it in a loop or thread somewhere.
//
////////////////////////////////////////////////////////////////
