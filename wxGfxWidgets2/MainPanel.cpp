...
MainPanel::MainPanel(wxWindow* parent)
		  :GObjectPanel(parent)
{ 
	object.push_back(new GAnimate(this, 100, wxPoint(0,0), wxT("fireBG#.png"), 90));
	//object.push_back(new GAnimate(this, 101, wxPoint(500,210), wxT("hulk#.png"), 100));
	//object.push_back(new GAnimate(this, 102, wxPoint(150,210), wxT("ken#.png"), 50));
	...
	//object.push_back(new GSlider(this, 107, wxPoint(200,400), wxT("sliderBG.png"), wxT("sliderKnob.png")));
...
void MainPanel::OnGToggle1(GToggleEvent &event)
{
	if(object[5]->GetValue() == true){
		...
		timer->Start((int)object[7]->GetValue(0),false);
	}
	else{
